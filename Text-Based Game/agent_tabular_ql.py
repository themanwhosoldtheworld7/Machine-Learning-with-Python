...
NUM_RUNS = 10
NUM_EPOCHS = 200
NUM_EPIS_TRAIN = 200  # number of episodes for training at each epoch
...
def tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
    ...
    """
    # TODO Your code here
    Q = 0 if terminal else np.max(q_func[next_state_1, next_state_2,:,:]) 
        
    q_func[current_state_1, current_state_2, action_index,
           object_index] = (1-ALPHA) * q_func[current_state_1, current_state_2,action_index, object_index] + ALPHA*(reward + GAMMA*Q)
